...
/// <summary>
/// Checks GitHub Releases for the latest version of the MCP Server.
/// </summary>
internal static class NuGetVersionChecker
{
    private const string LatestReleaseUrl = "https://api.github.com/repos/Asaceoo/Execl-mcp/releases/latest";
    private const string UserAgent = "jyyj-mcp-McpServer";
