...
- **`excel-mcp`** — MCP Server with 31 tools (328 operations) for conversational AI (Claude Desktop, Copilot chat)
...
Provides the full MCP Server with 31 tools (328 operations) for conversational AI:
